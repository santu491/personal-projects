...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AEPCore/AEPCore_Resources.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AEPServices/AEPServices_Resources.bundle"
