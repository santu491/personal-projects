...
export CA_APM_HOSTNAME="Admin-Portal-API-$ENV"
...
node_modules/.bin/pm2-runtime process.yml --only adminresources -- --app=adminresources --api=$API --env=$ENV --cid=$containerId
