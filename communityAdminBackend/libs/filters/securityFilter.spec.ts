...
import { mockInputScanner } from '@anthem/communityadminapi/security/mocks/mockInputScanner';
...
describe('SecurityFilter UTest', () => {
  ...
  it('should not allow blacklisted charachters in url param value', () => {
    ...
    try {
      ...
      expect(e.message.indexOf('URL Param value not allowed: test$1') >= 0).toBeTruthy();
    }
  });
