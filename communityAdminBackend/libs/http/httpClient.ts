...
export class HttpClient implements IHttpClient {
  ...
  mockHttp(http: request.RequestAPI<request.Request, request.CoreOptions, request.RequiredUriUrl>) {
    this._http = http;
  }
  ...
  protected runRequestInterceptors(request: IHttpRequest): IHttpRequest {
  ...
  protected trimSpaces(request: IHttpRequest): IHttpRequest {
  ...
  protected runResponseInterceptors(response: IHttpResponse, request: IHttpRequest, interceptors: IHttpResponseInterceptor[]): IHttpResponse {
