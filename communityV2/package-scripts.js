...
process.env.npm_config_app = args.app || process.env.npm_config_app || 'communityresources';
//process.env.npm_config_api = args.api || process.env.npm_config_api || 'all';
...
const pkgName = args.pkgName || process.env.npm_config_pkgName || '@anthem/communityapi';
...
module.exports = {
  scripts: {
    ...
    copy: {
      ...
      nsfw: {
        script: `"node_modules/.bin/cpy" ./app/${process.env.npm_config_app}/nsfwjs ./dist/`,
        hiddenFromHelp: true
      },
      buildkeytools: {
